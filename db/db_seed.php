...
$selected_medical = array_slice($medical_conditions, array_rand($medical_conditions, rand(1, 3)), rand(1, 3));
$selected_allergies = array_slice($common_allergies, array_rand($common_allergies, rand(1, 3)), rand(1, 3));
$selected_notes = array_slice($special_notes, array_rand($special_notes, rand(1, 2)), rand(1, 2));
